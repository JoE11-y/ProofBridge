...
describe('Admin E2E', () => {
  ...
  it('POST /admin/login -> returns tokens for valid credentials', async () => {
  ...
  it('POST /admin/login -> 400 for missing fields or invalid ones', async () => {
  ...
  it('POST /admin/login -> 401 for invalid credentials', async () => {
    await request(app.getHttpServer())
      .post('/admin/login')
  ...
  it('POST /admin/addAdmin -> requires auth, creates new admin', async () => {
    ...
    // 3) verify it actually exists in DB
  ...
  it('POST /admin/addAdmin -> 403 without token', async () => {
    await request(app.getHttpServer())
      .post('/admin/addAdmin')
  ...
  it('POST /admin/addAdmin -> 403 with invalid token', async () => {
    await request(app.getHttpServer())
      .post('/admin/addAdmin')
